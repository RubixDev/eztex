...
\renewcommand{\lstlistlistingname}{Programmblockverzeichnis}
...
\newcommand{\boxedinputlisting}[3][]{\tcbinputlisting{
    enhanced,
    % breakable,
    boxrule=0pt,
    frame hidden,
    ...
    listing only,
    listing remove caption=false,
    listing options={nolol=false, #2},
    listing file=#3,
    #1
}}
\newcommand{\code}[2][]{\lstinline[basicstyle=\ttfamily, #1]|#2|}
\newcommand{\rustcode}[1]{\code[style=Rust]{#1}}
\newcommand{\javacode}[1]{\code[style=Java]{#1}}
